  ...
  return (
    <div className="min-h-screen container mx-auto px-20 shadow">
      <div className="mt-8 p-8 rounded shadow-md">
          <h6 className="text-center text-3xl font-bold mb-8">جزئیات حساب کاربری</h6>
          <p className="text-xl">
        ...
        <div className="mt-8">
          <p className="text-center font-semibold text-xl my-4">لیست محصولات خریداری شده</p>
            ...
            <tbody className="text-gray-700">
              {buyProducts.map((product) => (
                <tr key={product.id} className="border-b *:py-3 *:px-4">
                  ...
                  <td className="py-3 px-4">{product.raiting !== null ? product.raiting : "N/A"}</td>
